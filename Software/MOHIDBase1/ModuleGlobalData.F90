...
!~     public  ::  CheckDynamicPropertyName
    ...
    integer, parameter :: GRID_COORD_       = 5         !Coordenadas relativas � origem da malha
    ...
    !Angles Referential
    integer, parameter :: NauticalReferential_              = 1   !0� is from N, 90� is from E
    integer, parameter :: CurrentsReferential_              = 2   !0� is to N, 90� is to E
